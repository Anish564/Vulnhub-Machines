:::::::::::::::::::::::::::: page
# LazySysAdmin: 1 {#lazysysadmin-1 .title}
...
- **[LazySysAdmin: 1]{style="color:#663e0e;"}** :-

<!-- -->

- Download the machine : <http://vulnhub.com/entry/lazysysadmin-1,205/>
...
1.  [SMB Enumeration]{style="color:#3584e4;"} :
2.  Smb login :
...
- Download all txt file in kali terminal :
...
- IP visit in browser : <http://192.168.2.166>
  <http://192.168.2.166/wordpress/> <http://192.168.2.166/test/>
  <http://192.168.2.166/robots.txt> <http://192.168.2.166/info.php>
  <http://192.168.2.166/phpmyadmin/>
  <http://192.168.2.166/wordpress/wp-login.php>
  <http://192.168.2.166/apache/> <http://192.168.2.166/old/>
...
![](images/797-12.png) Login Sucessfully .

1.  [Reverse Shell]{style="color:#3584e4;"} :

- After Login go to appearance :

::: codebox
    Appearance → editor → Twenty Fifteen → 404.php
:::

![](images/797-13.png) Upper PHP code replace with reverse shell code .

- Insert reverse payload :
...
![](images/797-15.png) Normal user found .
